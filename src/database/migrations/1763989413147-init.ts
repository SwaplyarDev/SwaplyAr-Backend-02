...
export class Init1763989413147 implements MigrationInterface {
  name = 'Init1763989413147';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment_methods" ("payment_method_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "platform" "public"."payment_methods_platform_enum" NOT NULL, "method" character varying(50) NOT NULL, "type" character varying(50), "pix_id" character varying, "pix_key" character varying, "pix_value" character varying, "cpf" character varying(14), "currency" character varying, "email_account" character varying, "transfer_code" character varying, "bank_name" character varying, "send_method_key" character varying, "send_method_value" character varying, "document_type" character varying, "document_value" character varying, "network" character varying, "wallet" character varying, CONSTRAINT "PK_397415468d59f5743a83c6c7bef" PRIMARY KEY ("payment_method_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "payment_platforms" ("payment_platform_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(50) NOT NULL, "title" character varying(100) NOT NULL, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_e678f0a05413cf27b7df659a4c6" UNIQUE ("code"), CONSTRAINT "PK_0e0bf75de755ff2e34d8e69ee17" PRIMARY KEY ("payment_platform_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "virtual_bank_accounts" ("bank_account_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email_account" character varying NOT NULL, "account_alias" character varying, "currency" character varying(3), "owner_type" character varying(20) NOT NULL DEFAULT 'user', "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "paymentProviderPaymentProviderId" uuid NOT NULL, "createdById" uuid NOT NULL, CONSTRAINT "PK_758f64b55b6712898249e18adf7" PRIMARY KEY ("bank_account_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "crypto_networks" ("crypto_network_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(20) NOT NULL, "title" character varying(100) NOT NULL, "logo_url" character varying, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_bfa8d74360ab815db95d0846301" UNIQUE ("code"), CONSTRAINT "PK_40f8e6af65c9d7fe6886dce3f6a" PRIMARY KEY ("crypto_network_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "crypto_accounts" ("bank_account_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "wallet_address" character varying NOT NULL, "tag_or_memo" character varying, "owner_type" character varying(20) NOT NULL DEFAULT 'user', "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "paymentProviderPaymentProviderId" uuid NOT NULL, "cryptoNetworkCryptoNetworkId" uuid NOT NULL, "createdById" uuid NOT NULL, CONSTRAINT "PK_18911acfe22d8e54a72c56f2c6e" PRIMARY KEY ("bank_account_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "payment_providers" ("payment_provider_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "code" character varying(50) NOT NULL, "country" character varying(3), "logo_url" character varying, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "paymentPlatformPaymentPlatformId" uuid NOT NULL, CONSTRAINT "UQ_3b92bdeea5c610e84052154ef25" UNIQUE ("code"), CONSTRAINT "UQ_aefbfe17f99f122889c968f08c4" UNIQUE ("paymentPlatformPaymentPlatformId", "code"), CONSTRAINT "PK_ae5be9356ec8fd4afaa584f10f0" PRIMARY KEY ("payment_provider_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bank_accounts" ("bank_account_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "holder_name" character varying NOT NULL, "document_type" character varying, "document_value" character varying, "bank_name" character varying, "account_number" character varying, "iban" character varying, "swift" character varying, "currency" character varying(3), "owner_type" character varying(20) NOT NULL DEFAULT 'user', "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "paymentProviderPaymentProviderId" uuid NOT NULL, "createdById" uuid NOT NULL, CONSTRAINT "PK_ba3381b91f6f67fed016e798296" PRIMARY KEY ("bank_account_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_providers" DROP COLUMN "paymentPlatformPaymentPlatformId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_providers" ADD "paymentPlatformPaymentPlatformId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_providers" ADD "payment_platform_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_providers" ADD CONSTRAINT "UQ_768a29dc3f86bee01e0cfc12b3e" UNIQUE ("payment_platform_id", "code")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" ADD CONSTRAINT "FK_0d768d3eab2e245787c74ec64e7" FOREIGN KEY ("userId") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" ADD CONSTRAINT "FK_2b69445a944419101ef0a96bcc5" FOREIGN KEY ("paymentProviderPaymentProviderId") REFERENCES "payment_providers"("payment_provider_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" ADD CONSTRAINT "FK_e78d1c6ed5114ebbc45c1371569" FOREIGN KEY ("createdById") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" ADD CONSTRAINT "FK_8f5fc43c8bdfa56dd29c40d59f3" FOREIGN KEY ("userId") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" ADD CONSTRAINT "FK_8f301d58475ba0a79cb8cc75706" FOREIGN KEY ("paymentProviderPaymentProviderId") REFERENCES "payment_providers"("payment_provider_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" ADD CONSTRAINT "FK_4a5991d3e8c9c1b5d1e1a4dab5f" FOREIGN KEY ("cryptoNetworkCryptoNetworkId") REFERENCES "crypto_networks"("crypto_network_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" ADD CONSTRAINT "FK_8ccc3bed87b97d006b09877320d" FOREIGN KEY ("createdById") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_providers" ADD CONSTRAINT "FK_b2ed8e6c791508ea2cef41fd609" FOREIGN KEY ("paymentPlatformPaymentPlatformId") REFERENCES "payment_platforms"("payment_platform_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" ADD CONSTRAINT "FK_45ef3ca170943e2c70e8073a7c5" FOREIGN KEY ("userId") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" ADD CONSTRAINT "FK_cf10962e114a00b94f8f0f718a7" FOREIGN KEY ("paymentProviderPaymentProviderId") REFERENCES "payment_providers"("payment_provider_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" ADD CONSTRAINT "FK_31ae4e2b8b8858c5b965af7090b" FOREIGN KEY ("createdById") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "financial_account" ADD CONSTRAINT "FK_5abfd9b9aa535c05a8c6d51f729" FOREIGN KEY ("payment_platform_id") REFERENCES "payment_platforms"("payment_platform_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "financial_account" DROP CONSTRAINT "FK_5abfd9b9aa535c05a8c6d51f729"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" DROP CONSTRAINT "FK_31ae4e2b8b8858c5b965af7090b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" DROP CONSTRAINT "FK_cf10962e114a00b94f8f0f718a7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "bank_accounts" DROP CONSTRAINT "FK_45ef3ca170943e2c70e8073a7c5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_providers" DROP CONSTRAINT "FK_b2ed8e6c791508ea2cef41fd609"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" DROP CONSTRAINT "FK_8ccc3bed87b97d006b09877320d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" DROP CONSTRAINT "FK_4a5991d3e8c9c1b5d1e1a4dab5f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" DROP CONSTRAINT "FK_8f301d58475ba0a79cb8cc75706"`,
    );
    await queryRunner.query(
      `ALTER TABLE "crypto_accounts" DROP CONSTRAINT "FK_8f5fc43c8bdfa56dd29c40d59f3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" DROP CONSTRAINT "FK_e78d1c6ed5114ebbc45c1371569"`,
    );
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" DROP CONSTRAINT "FK_2b69445a944419101ef0a96bcc5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "virtual_bank_accounts" DROP CONSTRAINT "FK_0d768d3eab2e245787c74ec64e7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_providers" DROP CONSTRAINT "UQ_768a29dc3f86bee01e0cfc12b3e"`,
    );
    await queryRunner.query(`ALTER TABLE "payment_providers" DROP COLUMN "payment_platform_id"`);
    await queryRunner.query(
      `ALTER TABLE "payment_providers" DROP COLUMN "paymentPlatformPaymentPlatformId"`,
    );
    await queryRunner.query(
