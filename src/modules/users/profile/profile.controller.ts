...
import { ApiTags, ApiBearerAuth, ApiOperation, ApiResponse, ApiBody, ApiConsumes, ApiOkResponse } from '@nestjs/swagger';
...
async updateSocials(
  @Req() req: any,
  @Body() updateUserSocialsDto: UpdateUserSocialsDto,
) {
  const userId = req.user?.id;
  ...
  schema: {
    example: {
      ...
      result: {
        imgUrl: 'https://res.cloudinary.com/dy1jiclwg/image/upload/v1759156800/profile-pictures/profile_d8e5fcb1-cf4b-4de9-823a-b075dfadaca2_1759156797456.png'
      }
    }
  }
  })
