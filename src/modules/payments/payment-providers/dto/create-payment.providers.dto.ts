import { IsString, IsOptional, IsBoolean, Length, MaxLength, ValidateNested } from 'class-validator';
...
export class CreatePaymentProvidersDto {
  ...
  @ApiProperty({ description: 'Logo del proveedor', example: 'https://res.cloudinary.com/dwrhturiy/image/upload/v1726600628/paypal.dark_lgvm7j.png' })
  @IsOptional()
  @IsString()
  logo_url?: string;
  ...
  @ApiProperty({ description: 'Id la plataforma de pago asociada', example: 'c2f08fd7-5ab5-4c66-8fa5-85103a49db31' })
  @ValidateNested()
