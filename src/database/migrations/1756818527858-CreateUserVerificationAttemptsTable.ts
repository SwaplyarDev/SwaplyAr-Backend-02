...
export class CreateUserVerificationAttemptsTable1756818527858 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" DROP CONSTRAINT "fk_financial_accounts_payment_method"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "platform" "public"."payment_methods_platform_enum" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "method" character varying NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "virtual_bank_id" character varying`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "send_method_key" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "send_method_value" character varying`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "notes" ADD "note_id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "notes" ADD CONSTRAINT "PK_77f245eb03df887f6f03c57f7f5" PRIMARY KEY ("note_id")`,
    );
    await queryRunner.query(`ALTER TABLE "notes" ADD "img_url" character varying`);
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "transaction_id" character varying(10) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "PK_9162bf9ab4e31961a8f7932974c" PRIMARY KEY ("transaction_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "country_transaction" character varying NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "final_status" "public"."transactions_final_status_enum" NOT NULL DEFAULT 'pending'`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "isNoteVerified" boolean NOT NULL DEFAULT false`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "UQ_c3f53f3fa7100cb3fbd2c09c6e6" UNIQUE ("note_id")`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" ADD "regret_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "UQ_e006fc4547b2051900939febb6c" UNIQUE ("regret_id")`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" ADD "payments_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "UQ_cdee4818a64ef6555829c23f519" UNIQUE ("payments_id")`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" ADD "amount_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "UQ_2ca3a8b59e96c792e4ec3c0dc8a" UNIQUE ("amount_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "account_id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD CONSTRAINT "PK_7db53a014418432811b1eb1aa97" PRIMARY KEY ("account_id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" ALTER COLUMN "payment_method_id" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "notes" ADD CONSTRAINT "UQ_1cd1479d6f04cc72659f5921e6f" UNIQUE ("transaction_id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "status" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user_account" DROP COLUMN "status"`);
    await queryRunner.query(
      `CREATE TYPE "public"."admin_status_enum" AS ENUM('pending', 'review_payment', 'approved', 'rejected', 'refund_in_transit', 'in_transit', 'discrepancy', 'canceled', 'modified', 'refunded', 'completed')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "status" "public"."admin_status_enum" NOT NULL DEFAULT 'pending'`,
    );
    await queryRunner.query(`ALTER TABLE "user_account" DROP COLUMN "user_id"`);
    ...
    await queryRunner.query(`ALTER TABLE "user_account" DROP COLUMN "account_name"`);
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "account_name" character varying(255) NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "created_at"`);
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "notes" DROP COLUMN "created_at"`);
    await queryRunner.query(
      `ALTER TABLE "notes" ADD "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "notes" DROP COLUMN "message"`);
    ...
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" ALTER COLUMN "payment_method_id" DROP NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "financial_accounts" ALTER COLUMN "type" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "financial_accounts" DROP COLUMN "last_name"`);
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" ADD "last_name" character varying(255)`,
    );
    await queryRunner.query(`ALTER TABLE "financial_accounts" DROP COLUMN "first_name"`);
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" ADD "first_name" character varying(255)`,
    );
    await queryRunner.query(`ALTER TABLE "user_account" DROP COLUMN "account_type"`);
    await queryRunner.query(
      `ALTER TABLE "user_account" DROP CONSTRAINT "PK_7db53a014418432811b1eb1aa97"`,
    );
    await queryRunner.query(`ALTER TABLE "user_account" DROP COLUMN "account_id"`);
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "UQ_2ca3a8b59e96c792e4ec3c0dc8a"`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "amount_id"`);
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "UQ_cdee4818a64ef6555829c23f519"`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "payments_id"`);
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "UQ_e006fc4547b2051900939febb6c"`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "regret_id"`);
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "UQ_c3f53f3fa7100cb3fbd2c09c6e6"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "PK_9162bf9ab4e31961a8f7932974c"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "currency" character varying(10) NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."platform_enum" AS ENUM('bank', 'paypal', 'wise', 'payoneer', 'pix', 'virtual_bank', 'receiver_crypto')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "platform" "public"."platform_enum" NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_account" ADD CONSTRAINT "user_account_pkey" PRIMARY KEY ("id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "transactions" ADD "amount" numeric(15,2) NOT NULL`);
    await queryRunner.query(
      `CREATE TYPE "public"."transaction_status_enum" AS ENUM('pending', 'review_payment', 'approved', 'rejected', 'refund_in_transit', 'in_transit', 'discrepancy', 'canceled', 'modified', 'refunded', 'completed', 'stop')`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "status" "public"."transaction_status_enum" NOT NULL DEFAULT 'pending'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "notes" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(`ALTER TABLE "notes" ADD CONSTRAINT "notes_pkey" PRIMARY KEY ("id")`);
    await queryRunner.query(
      `ALTER TABLE "payment_methods" ADD "method_name" character varying(100) NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "financial_accounts" ADD CONSTRAINT "fk_financial_accounts_payment_method" FOREIGN KEY ("payment_method_id") REFERENCES "payment_methods"("payment_method_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
