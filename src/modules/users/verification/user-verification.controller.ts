...
export class UserVerificationController {
  ...
  @ApiOperation({
    ...
    description:
      'Permite a los administradores listar todas las verificaciones pendientes.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          example:
            'Verificaciones con estado PENDIENTE obtenidas correctamente',
        },
  ...
  async listPending() {
    const verifications =
      await this.verificationService.findPendingVerifications();
  ...
  @ApiOperation({
    ...
    description:
      'Permite a los administradores aprobar o rechazar una verificación.',
  })
  @ApiParam({
    name: 'verificationId',
    ...
    schema: {
      ...
      properties: {
        ...
        note_rejection: {
          type: 'string',
          description:
            'Motivo del rechazo (requerido si el estado es REJECTED)',
