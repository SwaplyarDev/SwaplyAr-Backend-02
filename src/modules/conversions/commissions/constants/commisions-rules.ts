...
export const COMMISSION_RULES = [
  ...
  { from: 'Banco BRL', to: 'Wise USD', rate: 0.04, chargedBy: 'destination' },
  { from: 'Banco ARS', to: 'Wise EUR', rate: 0.04, chargedBy: 'destination' },
  { from: 'Banco BRL', to: 'Wise EUR', rate: 0.04, chargedBy: 'destination' },
  ...
  { from: 'PayPal EUR', to: 'PayPal USD', rate: 0.14, chargedBy: 'destination' },
  ...
  { from: 'Payoneer USD', to: 'Banco BRL', rate: 0.04, chargedBy: 'destination' },
